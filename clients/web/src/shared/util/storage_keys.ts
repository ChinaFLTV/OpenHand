...
//
// 迁移余量：SessionDetailPage 的 openhand.web.composer_collapsed、
// useMessageContentFormat 的 openhand_message_content_format /
// openhand_html_render_fallback 及其变更事件仍在原文件内声明（登记时
// 对应文件有在途改动），后续顺手迁入即可。

// ── localStorage 键（统一经 shared/util/browser_storage 读写） ──────────
export const STORAGE_KEY_PREFIX = 'openhand.web.';
