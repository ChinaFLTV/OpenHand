...
const TRANSCRIPT_SCROLL_ACTIVITY_SETTLE_MS = DIALOG_MOTION_DEFAULT_DURATION_MS;
const TRANSCRIPT_SCROLL_ACTIVITY_MIN_MS = DIALOG_MOTION_MIN_ANIMATED_DURATION_MS;
