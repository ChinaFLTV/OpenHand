...
const int kWebGatewayDefaultWorkspaceFileMaxBytes = kBytesPerMiB;
const int kWebGatewayMinWorkspaceFileMaxBytes = kBytesPerKiB;
...
const int kWebGatewayMinUploadCacheMaxBytes = kBytesPerMiB;
...
const int kWebGatewayMinLogFileMaxBytes = kBytesPerMiB;
