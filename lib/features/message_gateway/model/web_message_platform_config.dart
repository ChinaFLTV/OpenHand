...
const int kWebGatewayMessageRequestMaxBytes = 24 * 1024 * 1024;
const int kWebGatewayAttachmentMaxFileBytes = 10 * 1024 * 1024;
const int kWebGatewayAttachmentMaxTotalBytes = 16 * 1024 * 1024;
