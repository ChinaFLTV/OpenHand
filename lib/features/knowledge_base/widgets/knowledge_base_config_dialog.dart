...
class _KnowledgeBaseConfigDialogState
  ...
  Widget build(BuildContext context) {
    ...
    return OpenHandEditorDialogScaffold(
      ...
      subtitle: t(
        zh: '嵌入、分块、检索与 Qdrant 运维参数。',
        zhHant: '嵌入、分塊、檢索與 Qdrant 維運參數。',
        en: 'Embedding, chunking, retrieval, and Qdrant ops.',
        fr: 'Embedding, découpage, recherche et ops Qdrant.',
        de: 'Embedding, Chunking, Abruf und Qdrant-Betrieb.',
        ja: '埋め込み、チャンク、検索、Qdrant 運用。',
      ),
          ...
          _section(
            ...
            children: [
              ...
              _dropdown(
                ...
                onChanged: (value) {
                  setState(
                    () => _settings = _settings.copyWith(distanceMetric: value),
                  );
                },
              ),
              ...
              _switch(
                ...
                (value) => setState(
                  () => _settings = _settings.copyWith(autoStartSidecar: value),
                ),
              ),
            ],
          ),
          _section(
            ...
            children: [
              _dropdown(
                ...
                onChanged: (value) {
                  setState(
                    () => _settings = _settings.copyWith(chunkStrategy: value),
                  );
                },
              ),
              _dropdown(
              ...
              _dropdown(
                ...
                onChanged: (value) {
                  setState(
                    () =>
                        _settings = _settings.copyWith(pdfParsingEngine: value),
                  );
                },
              ),
              _dropdown(
                ...
                onChanged: (value) {
                  setState(
                    () =>
                        _settings = _settings.copyWith(htmlParsingMode: value),
                  );
                },
              ),
              _dropdown(
          ...
          _section(
            ...
            children: [
              ...
              _dropdown(
                ...
                onChanged: (value) {
                  setState(
                    () => _settings = _settings.copyWith(tagFilterMode: value),
                  );
                },
              ),
              _dropdown(
                ...
                onChanged: (value) {
                  setState(
                    () => _settings = _settings.copyWith(dateFilterMode: value),
                  );
                },
              ),
              _field(
                            ...
                            if (_settings
                              ...
                              KnowledgeDialogNotice(
                                ...
                                message: t(
                                  ...
                                  zhHant: '目前嵌入模型未標記「重排序」能力，仍會請求下方選擇的重排序模型。',
          ...
          _section(
            ...
            children: [
              ...
              _switch(
                ...
                (value) {
                  setState(
                    () => _settings = _settings.copyWith(includeChunkId: value),
                  );
                },
              ),
            ],
            ...
            children: [
              _dropdown(
                ...
                onChanged: (value) {
                  setState(
                    () =>
                        _settings = _settings.copyWith(failureStrategy: value),
                  );
                },
              ),
              _switch(
  ...
  Widget _readerParserRulesPanel({
    ...
    return DecoratedBox(
      decoration: BoxDecoration(
        ...
        borderRadius: kOpenHandBorderRadius16,
        border: Border.all(color: colorScheme.tertiary.withValues(alpha: 0.20)),
      ),
      child: Padding(
        padding: const EdgeInsets.all(14),
        child: Column(
  ...
  Widget _readerParserRuleRow({
    ...
    final accent = knowledgeSourceKindAccent(sourceType, colorScheme);
    return DecoratedBox(
      decoration: BoxDecoration(
        color: Color.alphaBlend(
              ...
              children: [
                DecoratedBox(
                  ...
                  child: SizedBox(
                    ...
                    height: 32,
                    child: Icon(
                      knowledgeSourceKindIcon(sourceType),
                      size: 16,
                      color: accent,
                    ),
                  ),
                ...
                SizedBox(
                  ...
                  child: AnimatedDropdownButtonFormField<String>(
                    ...
                    isExpanded: true,
                    decoration:
                        knowledgeDialogInputDecoration(
                          context,
                          openHandLocalizedText(
                            context,
                            zh: '解析方式',
                            ...
                            if (readerModels.isEmpty)
                              ...
                              OpenHandModelSelectorField(
                                ...
                                onSelected: (selection) {
                                  ...
                                  final profile = config.profileFor(
                                    selection.$2,
                                  );
                                  final targets = profile.readerTargetTypes
                                      .where(
                                        ReaderFileType.targetTypes.contains,
                                      )
                                      .toList(growable: false);
                                  final target =
                                      targets.contains(rule.targetType)
                                      ? rule.targetType
                                      : (targets.isEmpty
                                            ? ReaderFileType.markdown
                                            : targets.first);
