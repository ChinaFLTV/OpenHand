...
class AiPromptTemplateRepository {
  ...
  static const List<AiThreadTemplate> _templates = <AiThreadTemplate>[
    AiThreadTemplate(
      ...
      description:
          'A balanced general-purpose template for tool-assisted work, MCP usage, and accurate skill recognition.',
...
You are OpenHand, a reliable desktop assistant.

- Help with analysis, coding, shell tasks, MCP-assisted workflows, and structured tool use.
