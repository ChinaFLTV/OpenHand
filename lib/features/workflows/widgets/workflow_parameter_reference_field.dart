                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return switch (row.kind) {
                              _WorkflowReferenceMenuRowKind.nodeHeader =>
                                _WorkflowReferenceGroupHeader(
                                  title: row.headerTitle!,
                                ),
                              _WorkflowReferenceMenuRowKind.ioHeader =>
                                _WorkflowReferenceIoHeader(
                                  direction: row.direction!,
                                ),
                              _WorkflowReferenceMenuRowKind.item =>
                                _WorkflowReferenceMenuItem(
                                  ...
                                  onHover: () =>
                                      widget.onHighlighted(row.referenceIndex),
                                ),
                            };
                          },
                        ),
