      ...
      matched.add(
        WebReverseLaunchCause(
          title: text(
            ...
            fr: 'Le verrou du profil est utilisé par une autre instance Chrome',
          ...
          suggestion: text(
            ...
            fr: 'Fermez tous les processus Chrome, nettoyez le profil en conflit pour supprimer les fichiers SingletonLock restants, puis réessayez.',
            de: 'Schließen Sie alle Chrome-Prozesse, bereinigen Sie das betroffene Profil, um restliche SingletonLock-Dateien zu entfernen, und versuchen Sie es erneut.',
      ...
      matched.add(
        WebReverseLaunchCause(
          title: text(
            ...
            fr: 'Le port de débogage distant est déjà utilisé',
      ...
      matched.add(
        WebReverseLaunchCause(
          title: text(
            ...
            fr: 'Une stratégie d’entreprise bloque le débogage distant',
          ...
          suggestion: text(
            ...
            fr: 'Vérifiez si RemoteDebuggingAllowed est désactivé dans /Library/Managed Preferences/com.google.Chrome.plist sur macOS ou HKLM\\Software\\Policies\\Google\\Chrome sous Windows. Si possible, essayez un navigateur personnel comme Brave ou Chrome Beta.',
            de: 'Prüfen Sie, ob RemoteDebuggingAllowed unter macOS in /Library/Managed Preferences/com.google.Chrome.plist oder unter Windows in HKLM\\Software\\Policies\\Google\\Chrome deaktiviert ist. Falls möglich, testen Sie einen persönlichen Browser wie Brave oder Chrome Beta.',
      ...
      matched.add(
        WebReverseLaunchCause(
          title: text(
            ...
            fr: 'Échec de l’initialisation du bac à sable',
          ...
          suggestion: text(
            ...
            fr: 'Sous Linux, vérifiez que /usr/lib/chromium-browser/chrome-sandbox a le bit SUID, ou lancez temporairement avec --no-sandbox uniquement pour diagnostiquer.',
      ...
      matched.add(
        WebReverseLaunchCause(
          title: text(
            ...
            fr: 'Échec de l’initialisation du processus GPU',
          ...
          suggestion: text(
            ...
            fr: 'Essayez de démarrer avec --disable-gpu si le lanceur expose les arguments supplémentaires, ou mettez à jour le pilote GPU / le système.',
      ...
      matched.add(
        WebReverseLaunchCause(
          title: text(
            ...
            fr: 'Un antivirus ou pare-feu bloque l’écoute sur 127.0.0.1',
          ...
          suggestion: text(
            ...
            fr: 'Ajoutez OpenHand.app et le navigateur à la liste de confiance, autorisez les ports 9222-9322 et, sur macOS, vérifiez Réglages Système > Réseau > Pare-feu.',
            de: 'Fügen Sie OpenHand.app und die Browser-Datei zur Vertrauensliste hinzu, erlauben Sie Ports 9222-9322 und prüfen Sie unter macOS Systemeinstellungen > Netzwerk > Firewall.',
      ...
      matched.add(
        WebReverseLaunchCause(
          title: text(
            ...
            fr: 'La requête /json/version a été bloquée par un proxy système',
          ...
          suggestion: text(
            ...
            fr: 'Vérifiez les proxys transparents, VPN, Proxifier ou outils similaires qui interceptent 127.0.0.1. OpenHand sonde localement, ajoutez donc 127.0.0.1 à la liste blanche.',
            de: 'Prüfen Sie transparente Proxys, VPN, Proxifier oder ähnliche Tools, die 127.0.0.1 abfangen. OpenHand prüft lokal, daher 127.0.0.1 zur Proxy-Ausnahmeliste hinzufügen.',
      ...
      matched.add(
        WebReverseLaunchCause(
          title: text(
            ...
            fr: 'Aucun sous-type précis ne correspond',
          ...
          suggestion: text(
            ...
            fr: 'Ouvrez l’action d’erreur brute et transmettez les détails au développeur. Vous pouvez d’abord fermer Chrome, nettoyer le profil en conflit, puis réessayer.',
            de: 'Öffnen Sie die Rohfehlermeldung und geben Sie die Details an den Entwickler weiter. Schließen Sie zuerst alle Chrome-Instanzen, bereinigen Sie das Profil und versuchen Sie es erneut.',
    ...
    return WebReverseLaunchDiagnosis(
      phenomenon: phenomenon.isEmpty
          ? text(
              ...
              fr: 'Échec du lancement du navigateur',
