...
export '../model/instruction_market.dart';

/// SkillHub 角色快照在本地适配，保留既有来源标识和提示词内容。
class _SkillHubInstructionEntry extends InstructionMarketEntry {
  const _SkillHubInstructionEntry({
    required super.id,
    required super.name,
    ...
    required super.approach,
    required super.tone,
    required super.interpretation,
  }) : super(
         avatarUrl:
             'https://cloudcache.tencent-cloud.com/qcloud/ui/static/other_external_resource/$avatarId.png',
         sourceKey: 'skillhub:soul:$id',
         localizationKey: id,
         body:
             '# $name Soul 配置\nrole: $role\nstyle: $style\napproach: $approach\ntone: $tone',
       );
