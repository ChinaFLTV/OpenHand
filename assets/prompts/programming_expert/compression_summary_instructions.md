...
- **Session State**：优先使用 `Compression Task Payload.session_state` 中的 mode、full_access_permission、awaiting_plan_approval、pending_plan、current_todos、recent_plan_records。
