...
[![Dart SDK](https://img.shields.io/badge/Dart-3.13.3-0175C2?logo=dart&logoColor=white)](https://dart.dev)
...
- Flutter `>=3.47.4`; CI uses Flutter `3.47.4` stable with its bundled Dart `3.13.3`.
